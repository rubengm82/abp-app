...
<div class="max-w-full mx-auto bg-white p-6 rounded shadow overflow-x-auto">
            ...
            <tbody>
                ...
                <tr class="hover:bg-base-300">
                    ...
                    <td class="flex justify-end gap-2">
                        ...
                        <a href="{{ route('professional_activate', $professional->id) }}" class="btn btn-sm btn-success">Activar</a>
                    </td>
                    </tr>
                @endif
            </tbody>
    ...
    <!-- TODO: Mover el icono y utilizar el svg master -->
        <div class="text-center py-12">
            ...
            <h3 class="text-xl font-semibold text-gray-600 mb-2">No hi ha professionals desactivats</h3>
            <p class="text-gray-500 mb-4">Tots els professionals estan actualment actius.</p>
        </div>
    @endif
