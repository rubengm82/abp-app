...
<x-partials.breadcrumb
    ...
    :current="'Afegir Incidència'"
    />
<div class="max-w-4xl mx-auto bg-base-100 p-6 rounded shadow">
    <h1 class="text-3xl font-bold text-base-content mb-6 text-center">Afegir incidència RRHH</h1>
    ...
    <form action="{{ route('hr_issue_add') }}" method="post" class="space-y-6">
        ...
        <div class="card shadow-xl">
            <div class="card-body">
                ...
                <div class="form-control">
                    ...
                    <textarea name="description" id="id_description" rows="6" placeholder="Descriu la incidència RRHH..." class="textarea textarea-bordered w-full" required>{{ old('description') }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="flex justify-end gap-4">
            ...
            <input type="submit" value="Crear Incidència" class="btn btn-info">
        </div>
    </form>
</div>
