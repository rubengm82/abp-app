...
<div class="flex justify-between items-center mb-3">
    <div>
        <x-partials.search-bar placeholder="Cercar per nom o contacte..." />
    </div>
    <div class="flex gap-4">
        <a href="{{ route('externalcontacts.downloadCSV') }}" class="btn btn-sm btn-secondary">Descarregar Llistat</a>
...
<div class="max-w-full mx-auto bg-base-100 mt-3 p-0 rounded-lg shadow-lg/10 scrollable-list-container border border-gray-500/20">
    ...
    @else
        <div class="text-center py-12">
            <h3 class="text-xl font-bold text-base-content mb-2">Encara no hi ha contactes externs registrats</h3>
