...
<div class="max-w-lg mx-auto bg-white p-6 rounded shadow">
    ...
    <form action="{{ route('center_add') }}" method="post" class="space-y-4">
        @csrf
        <input type="text" name="name" id="id_name" placeholder="Nom" class="input input-bordered w-full">
        ...
        <div class="flex gap-2">
            ...
            <input type="reset" value="cancel·lar" class="btn flex-1">
        </div>
    </form>
</div>
@endsection
