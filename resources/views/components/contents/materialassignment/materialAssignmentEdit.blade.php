...
<div class="max-w-4xl mx-auto bg-base-200 p-6 rounded-lg shadow-xl/10 border border-gray-500/20">
    ...
    <form action="{{ route('materialassignment_update', $materialAssignment) }}" method="POST" class="space-y-6">
            ...
            <div class="card-body">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="form-control">
                        <label class="label font-bold text-base-content mb-1"><span class="label-text">Professional *</span></label>
        ...
        <div class="card bg-base-100 shadow-xl">
            <div class="card-body">
                <h2 class="card-title text-xl mb-4 underline underline-offset-5">Talles d'Uniforme</h2>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="form-control">
                        <label class="label font-bold text-base-content mb-1"><span class="label-text">Talla samarreta</span></label>
                    ...
                    <div class="form-control">
                        <label class="label font-bold text-base-content mb-1"><span class="label-text">Talla pantaló</span></label>
                    ...
                    <div class="form-control">
                        <label class="label font-bold text-base-content mb-1"><span class="label-text">Talla sabata</span></label>
        ...
        <div class="card bg-base-100 shadow-xl">
            <div class="card-body">
                <h2 class="card-title text-xl mb-4 underline underline-offset-5">Detalls de l'Assignació</h2>
                <div class="space-y-4">
                    <div class="form-control">
                    ...
                    <div class="form-control">
                        <label class="label font-bold text-base-content mb-1"><span class="label-text">Observacions</span></label>
