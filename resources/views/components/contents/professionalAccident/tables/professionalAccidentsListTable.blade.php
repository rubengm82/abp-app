    ...
    <tbody>
        @foreach($accidents as $accident)
            <tr class="hover:bg-base-300 transition-colors">
                <td class="px-4 py-2">
                    <span class="badge badge-dash whitespace-normal text-center {{ $accident->type === 'Baja Finalitzada' ? 'badge-success' : ($accident->type === 'Con baja' ? 'badge-warning' : 'badge-info') }}">
                        {{ $accident->type }}
                    </span>
                </td>
