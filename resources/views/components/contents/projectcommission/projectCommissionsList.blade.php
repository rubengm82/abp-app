...
@section('content')
<h1 class="text-3xl font-bold text-gray-800 mb-6 text-center">Llista de projectes i comissions</h1>
...
<div class="max-w-full mx-auto bg-white p-6 rounded shadow overflow-x-auto">
    ...
    @else
        <div class="text-center py-12">
            ...
            <h3 class="text-xl font-semibold text-gray-600 mb-2">Encara no hi ha projectes/comissions registrats</h3>
            <p class="text-gray-500 mb-4">Comença afegint el primer projecte o comissió a la base de dades.</p>
