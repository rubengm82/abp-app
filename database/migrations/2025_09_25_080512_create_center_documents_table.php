...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('center_documents', function (Blueprint $table) {
            ...
            // FKs
            $table->foreign('center_id', 'center_documents_center_fk')->references('id')->on('centers')->onDelete('cascade');
            $table->foreign('uploaded_by_professional_id', 'center_documents_uploader_fk')->references('id')->on('professionals')->onDelete('cascade');
