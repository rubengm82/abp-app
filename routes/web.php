...
Route::middleware('auth')->post('/materialassignment/clear-signature/{id}', [MaterialAssignmentController::class, 'clearSignature']);
Route::middleware('auth')->post('/materialassignment/save-signature/{id}', [MaterialAssignmentController::class, 'saveSignature']);
