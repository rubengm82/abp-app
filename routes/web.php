...
Route::middleware('auth')->get('/professionals/evaluations/quiz/show/{professionalEvaluated}/{evaluation}', [EvaluationsController::class, "show"])->name("professional_evaluation_quiz_show");
